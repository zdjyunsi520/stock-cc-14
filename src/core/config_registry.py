...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LITELLM_MODEL": {
        "title": "Primary Model",
        "description": "Primary model in provider/model format (e.g. gemini/gemini-3.1-pro-preview, deepseek/deepseek-v4-flash, anthropic/claude-opus-4-6). If empty, it is auto-inferred from available API keys or channel declarations.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LITELLM_FALLBACK_MODELS": {
        ...
        "description": "Comma-separated fallback models tried when the primary model fails (e.g. anthropic/claude-opus-4-6,openai/gpt-5.4-mini). Useful for cross-provider redundancy.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "ANTHROPIC_MODEL": {
        ...
        "description": "Claude 模型名称（如 claude-opus-4-6）。",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FEISHU_WEBHOOK_URL": {
        ...
        "description": "Feishu custom bot webhook URL for group notifications. App bot delivery can alternatively use FEISHU_APP_ID / FEISHU_APP_SECRET / FEISHU_APP_CHAT_ID.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FEISHU_APP_ID": {
        "title": "Feishu App ID",
        "description": "Feishu app bot App ID for Stream bot mode, cloud documents, or proactive app bot delivery with FEISHU_APP_CHAT_ID.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FEISHU_APP_SECRET": {
        ...
        "description": "Feishu app bot App Secret for Stream bot mode, cloud documents, or proactive app bot delivery with FEISHU_APP_CHAT_ID.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FEISHU_APP_CHAT_ID": {
        "title": "Feishu App Chat ID",
        "description": "Target Feishu group chat ID for app bot proactive notifications. Used with FEISHU_APP_ID / FEISHU_APP_SECRET when no custom webhook is configured.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FEISHU_STREAM_ENABLED": {
        ...
        "description": "Enable Feishu application bot stream mode for receiving and replying to messages without a public webhook endpoint.",
        "category": "notification",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
