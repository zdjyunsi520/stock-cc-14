...
class TestCommandDispatcherSyncCompatibility(unittest.TestCase):
    def test_chinese_question_routes_to_ask_command_without_prefix(self):
        message = _make_message("问股 603687", mentioned=True)

        self.assertEqual(message.get_command_and_args("/"), ("ask", ["603687"]))
